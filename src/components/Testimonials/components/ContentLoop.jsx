...
export default function ContentLoop({ data }) {
  return (
    <div className="lg:space-y-0 sm:space-y-4 lg:text-center  sm:text-center  sm:whitespace-break-spaces">
      {data.Review && (
      ...
      <div className="flex flex-col items-end space-y-3">
        ...
        <span className="leading-5 lg:text-xl md:text-lg sm:text-sm sm:px-4 pb-3">{`${data.ClientOrganization}`}</span>
      </div>
